function [vecCalc, exitFlag] = orCalculator_interiorpoint(window,winRad,xInd,yInd,zInd,preVecCalc,minRes)
...
%     ub = [winRad; winRad; winRad; 1; 1; 1];
    ...
    [v,~,exitFlag] = fmincon(@fun_3d, [0, 0, winRad, preVecCalc(1), preVecCalc(2), preVecCalc(3)], A, b, Aeq, beq, lb, ub, @nonlcon, options);
